...
<article>
    <div class="content">
        <br><br>
        <h1>何らかのエラーが発生しました。登録に失敗しました。</h1>
        <form action="StudentResisterFailed" method="post">
            <input type="submit" name="returnMenu" value="メインメニュに戻る">
            <input type="submit" name="returnResister" value="メインメニュに戻る">
        </form>
    </div>
</article>
</body>
